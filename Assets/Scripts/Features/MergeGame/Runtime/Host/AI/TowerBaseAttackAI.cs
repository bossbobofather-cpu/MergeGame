    ...
    public sealed class TowerBaseAttackAI : IMergeTowerAI
    {
            ...
            List<MergeHostEvent> events)
        {
            ...
            for (var i = 0; i < specs.Count; i++)
            {
                ...
                if (tower.ASC.TryActivateAbility(spec, combatSystem.TargetContext, out var targetData))
                {
                    combatSystem.ExecuteTowerAttack(tick, tower, spec.Ability, targetData, events);
                }
            }
        }
    }
